...
public class Phase1Main {
    ...
    private static void testTradables() {
        ...
        try {
            tradable1 = new Order("USER1", "GE", PriceFactory.makeLimitPrice("$21.59"), 250, BookSide.BUY);
        ...
        try {
            Order order = new Order("USER1", "GE", PriceFactory.makeLimitPrice("$21.59"), 0, BookSide.BUY);
        ...
        try {
			System.out.println("\tQuoteSide's toString: " + quote1.getQuoteSide(BookSide.BUY));
		} catch (InvalidPriceOperation e1) {
			// TODO Auto-generated catch block
			e1.printStackTrace();
		} catch (TradableException e1) {
			// TODO Auto-generated catch block
			e1.printStackTrace();
		}
        try {
			System.out.println("\tQuoteSide's toString: " + quote1.getQuoteSide(BookSide.SELL) + "\n");
		} catch (InvalidPriceOperation e1) {
			// TODO Auto-generated catch block
			e1.printStackTrace();
		} catch (TradableException e1) {
    ...
    private static void makeSomeTestPriceObjects() throws InvalidPriceOperation	{
    ...
    private static void verifyFlyweight() throws InvalidPriceOperation	{
