...
public class Phase2Main {
    ...
    public static void main(String[] args) throws InvalidPriceOperation, UserException {
    ...
    private static void performLegacyTests() throws InvalidPriceOperation {
    ...
    private static void makeTestUsers() throws UserException, InvalidPriceOperation {
        u1 = new UserImpl("REX");
        u2 = new UserImpl("ANN");
        u3 = new UserImpl("OWL");
        u4 = new UserImpl("BEN");
    ...
    private static void testCurrentMarketPublisher() {
        try {
            ...
            System.out.println("6) Publish Current Market for SBUX. Now all 4 users are unsubscribed so no one gets a message");
