...
public class Phase3Main {
    ...
    public static void main(String[] args) throws UserException, InvalidPriceOperation {
    ...
    private static void doTestSet3(String stockSymbol) {
        ...
        System.out.println("        REX receives 6 Fill Messages, a Current Market, a Last Sale & a Ticker, and a cancel for the 40 remaining MKT order quantity not traded");
        try {
            ProductService.getInstance().submitOrder(
